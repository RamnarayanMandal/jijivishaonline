...
const Elegantjewellery = () => {
  ...
  return (
    <div className='flex lg:flex-row md:flex-row flex-col items-center lg:gap-10 mt-20 mb-10 py-10 sm:px-[6%] bg-slate-300 font-serif'>
      <h1 className='text-3xl sm:text-4xl text-center font-semibold text-gray-600 mb-8'>Elegant Jewellery</h1>
          ...
          {products?.map((product) => (
            <SwiperSlide key={product.id}>
              <div className="flex flex-col items-center cursor-pointer">
                <div className="mb-2" onClick={()=>navagite(`/product/${product._id}`)}>
                  <img
...
export default Elegantjewellery;
