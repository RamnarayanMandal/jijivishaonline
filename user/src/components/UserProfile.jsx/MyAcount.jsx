...
const MyAccount = () => {
  ...
  const [newName, setNewName] = useState(userProfile?.name || "raj");
  ...
  const handleUpdateName = async () => {
    ...
    try {
      const resp = await axios.post(`${URI}/user/addname/${userId}`, { name: newName });
  ...
  return (
    <div className='flex justify-evenly content-center items-center gap-4'>
      ...
      <div>
        ...
        <p className='my-1'>+91 {userProfile.mobileNumber || "N/A"}</p>
