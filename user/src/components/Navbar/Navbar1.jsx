...
const Navbar1 = () => {
  return (
    <div className="bg-white px-20 flex flex-col md:flex-row items-center h-[80px]">
      ...
      {/* Search Bar */}
      <div className="relative flex-grow w-full md:w-96 flex items-center">
  <input
    type="search"
    placeholder="Search for India's best products"
    className="w-full px-4 py-2 pl-10 border border-gray-300 rounded-l-lg focus:outline-none focus:border-blue-500"
  />
  {/* Search Button */}
