          ...
          {products.map((product) => (
            <SwiperSlide key={product.id}>
              <div className="flex-shrink-0 w-72 mx-2 items-center justify-center content-center my-10">
                ...
                <div className="  bg-[#ffffff] border-2  shadow-lg overflow-hidden hover:border-black transition-transform duration-300 transform hover:scale-105">
                  ...
                  <div className="p-4 flex flex-col justify-between">
                    ...
                    <div className="block justify-between items-center">
                        <p className='my-2'>sept 01, 2023</p>
