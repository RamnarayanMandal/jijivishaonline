...
const Modal = React.forwardRef(
  ({ isOpen, onClose, categoryData, expandedSubcategories, toggleSubcategories }, ref) => {
    ...
    return (
      <div
        ...
        style={{ animation: isOpen ? 'fadeIn 0.5s ease-out' : 'fadeOut 0.4s ease-in' }}
      >
        <div
          ...
          style={{ animation: isOpen ? 'slideUp 0.3s ease-out' : 'slideDown 0.3s ease-in' }}
        >
          {/* Close Button */}
          <button
            onClick={onClose}
