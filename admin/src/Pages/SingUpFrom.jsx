...
export const SignUpForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${URI}api/admin/register`, {
        email,
        password,
      });
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${URI}api/admin/verify-otp`, {
        email,
        otp,
      });
      ...
      setError(
        error.response ? error.response.data : "Invalid OTP. Please try again."
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="mx-auto grid w-[350px] gap-6">
          <div className="grid gap-2 text-center">
            <h1 className="text-3xl font-bold">
              {isRegistered ? "Enter OTP" : "Sign Up"}
            </h1>
